...
function guardarian_link($params)
{
	...
	$hrs_guardariancom_currency = $params['currency'];
	$callback_URL = $redirectUrl . '?invoice_id=' . $invoiceId;
	$hrs_guardariancom_final_total = $amount;
				
$hrs_guardariancom_gen_wallet = file_get_contents('https://api.highriskshop.com/control/wallet.php?address=' . $walletAddress .'&callback=' . urlencode($callback_URL));


	$hrs_guardariancom_wallet_decbody = json_decode($hrs_guardariancom_gen_wallet, true);
