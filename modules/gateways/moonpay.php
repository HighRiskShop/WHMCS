    ...
    if ($hrs_moonpaycom_wallet_decbody && isset($hrs_moonpaycom_wallet_decbody['address_in'])) {
		...
		$hrs_moonpaycom_gen_callback = $hrs_moonpaycom_wallet_decbody['callback_url'];
		 ...
		 // Update the invoice description to include address_in
            $invoiceDescription = "Payment reference number: $hrs_moonpaycom_gen_addressIn";
...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://api.highriskshop.com/control/process-payment.php?address=' . $hrs_moonpaycom_gen_addressIn . '&amount=' . $hrs_moonpaycom_final_total . '&provider=moonpay&email=' . urlencode($email) . '&currency=' . $hrs_moonpaycom_currency;
