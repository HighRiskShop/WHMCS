    ...
    if ($hrs_particlenetwork_wallet_decbody && isset($hrs_particlenetwork_wallet_decbody['address_in'])) {
		...
		$hrs_particlenetwork_gen_callback = $hrs_particlenetwork_wallet_decbody['callback_url'];
		 ...
		 // Update the invoice description to include address_in
            $invoiceDescription = "Payment reference number: $hrs_particlenetwork_gen_addressIn";
...
return "Error: Payment could not be processed, please try again (wallet address error)";
        ...
        $paymentUrl = 'https://api.highriskshop.com/control/process-payment.php?address=' . $hrs_particlenetwork_gen_addressIn . '&amount=' . $hrs_particlenetwork_final_total . '&provider=particle&email=' . urlencode($email) . '&currency=' . $hrs_particlenetwork_currency;
